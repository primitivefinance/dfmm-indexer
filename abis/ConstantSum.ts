export const ConstantSumAbi = [
  {
    type: "constructor",
    inputs: [{ name: "dfmm_", type: "address", internalType: "address" }],
    ...
    inputs: [
      ...
      { name: "poolId", type: "uint256", internalType: "uint256" },
      {
        ...
        components: [
          ...
          { name: "liquidityToken", type: "address", internalType: "address" },
          { name: "feeCollector", type: "address", internalType: "address" },
          { name: "controllerFee", type: "uint256", internalType: "uint256" },
        ],
      },
  ...
  },
  {
    ...
    outputs: [
      { name: "valid", type: "bool", internalType: "bool" },
      { name: "invariant", type: "int256", internalType: "int256" },
      { name: "deltas", type: "uint256[]", internalType: "uint256[]" },
      { name: "deltaLiquidity", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "view",
  },
  {
  ...
  { type: "error", name: "InvalidDeltaLiquidity", inputs: [] },
